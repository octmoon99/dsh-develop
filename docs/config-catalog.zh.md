...
需要：`agents` · `agentPresets` · `agentDefaultModel` · `permissionPresets` · `workspaceRegistry` · `sessionTitle` · `sessionPersistence` · `credentials` · `attachments`
...
需要：`tools` · `alarmQuery` · `systemPrompt`
