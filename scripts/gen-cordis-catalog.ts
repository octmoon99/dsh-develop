...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  AlarmQueryProvider: 'integration.md',
  AlarmQueryRequest: 'integration.md',
  AlarmQuerySpec: 'integration.md',
  AlarmQueryResult: 'integration.md',
